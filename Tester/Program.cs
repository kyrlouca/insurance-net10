...
var text=@"{d: [s2c_dim:DZ], filter:dim(this(), [s2c_dim:DZ]) = [s2c_GA:x114], seq: False, id: v0}";
//{d: [s2c_dim:LG], filter:dim(this(), [s2c_dim:LG]) = [s2c_GA:x113], seq: False, id: v0}
...
//var text = @"{}";
var xx1 = RuleExpressionTerm280.CreateRuleExpressionTerm(text);
